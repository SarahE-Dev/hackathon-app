    ...
    <div className="min-h-screen bg-dark-900 text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Link
            href="/judge/grading"
            className="glass rounded-2xl p-6 border-2 border-neon-blue/30 hover:border-neon-blue transition-all group"
          >
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold mb-2 group-hover:text-neon-blue transition-colors">Assessment Grading</h3>
                <p className="text-gray-400 text-sm">Review and grade student assessments</p>
              </div>
          ...
          <div className="glass rounded-2xl p-6 border-2 border-neon-purple/30">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold mb-2">Hackathon Projects</h3>
                <p className="text-gray-400 text-sm">Score hackathon team submissions below</p>
              </div>
